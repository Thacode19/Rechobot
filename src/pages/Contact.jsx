    ...
    <div className="bg-gray-50 dark:bg-gray-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
          Wil u ons contacten? kies gerust een van de onderstaande mogelijkheden.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 gap-y-8 md:gap-x-8">
        {/* Contact Info */}
        <div>
          <h2 className="text-lg font-bold dark:text-gray-100">Contact Ons</h2>
          <p className="max-w-sm mt-4 mb-4 dark:text-gray-400">
            Wi zijn hier om te helpen. Fill up the form or send an email or call us.
          </p>
          ...
          <div className="flex items-center mt-8 space-x-2 text-dark-600 dark:text-gray-400">
            ...
            <span>anoniemstraat, Paramaribo</span>
          </div>
